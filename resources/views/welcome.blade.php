        ...
        <nav class="fixed top-0 left-0 right-0 bg-transparent dark:bg-transparent z-10">
            <div class="max-w-screen-xl flex items-center justify-between mx-auto p-4">
                ...
                <div class="hidden  absolute top-full left-0 w-48 ms-20 bg-transparent z-10 rounded-lg dark:bg-transparent dark:border bg-opacity-50 backdrop-filter backdrop-blur-md dark:border-tbg-transparent" id="profile-dropdown">
                    <ul class="py-1">
                        <li><a href="{{ route('login') }}" class="block px-4 py-2 text-white">Login</a></li>
                        <li><a href="{{ route('register') }}" class="block px-4 py-2 text-white">Register</a></li>
                    </ul>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="block max-w-[18rem] rounded-lg bg-white text-center text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuaeEmrNOL3-Eay5qMk1o1Ehw1WCOQBe7CazTp4Q_-Q-lPI84dyhhVteFH4xWHWX2BwoA&usqp=CAU'); background-size: cover;">
                            <div class="p-6">
                                ...
                                <a type="button" href="#" class="pointer-events-auto inline-block cursor-pointer rounded text-base font-normal leading-normal text-white transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 dark:text-primary-400">
                                    view more
                                </a>
                            </div>
                        </div>  
