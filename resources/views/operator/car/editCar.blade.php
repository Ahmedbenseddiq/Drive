                    ...
                    <form action="{{ route('operator.storeCar') }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mt-4">
                                ...
                                <select id="car_detail_id" name="carDetail_id" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-select">
                                    ...
                                    @foreach ($carDetails as $carDetail)
                                        <option value="{{ $carDetail->id }}">{{ $carDetail->brand }},{{ $carDetail->model }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mt-4" hidden >
                                ...
                                <input id="operator_id" name="operator_id" type="text" value="{{ $user->id }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Operator ID" disabled />                           
                            </div>
                        </div>
